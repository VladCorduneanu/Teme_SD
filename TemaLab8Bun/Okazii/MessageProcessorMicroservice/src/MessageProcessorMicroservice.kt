...
class MessageProcessorMicroservice {
    ...
    init {
        ...
        taskManagerSocket = Socket(BIDDING_PROCESSOR_HOST, TASK_PORT)
        taskManagerSocket.getOutputStream().write(Message.create("${taskManagerSocket.localSocketAddress}","am pornit meesageProcessor",timestamp.toString()).serialize())
        ...
        val receiveInQueueSubscription = receiveInQueueObservable
            ...
            .subscribeBy(
                ...
                onComplete = {
                    ...
                    transmitToTaskManager("MessageProcessor-M-am oprit")
